...
const LABELS = {
  es: {
    ...
    offHintBody1:   'Este evento quedará oculto en el calendario. Puedes volver a activarlo con el mismo botón, o encontrarlo usando el filtro',
    offHintFilter:  '"Todos"',
    offHintBody2:   'Si quieres eliminarlo definitivamente, usa el ícono de la papelera 🗑.',
